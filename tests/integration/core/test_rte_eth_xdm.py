"""Integration test for Rte.xdm parsing from simple_demo_eth_rte.

Implements: SWR_INTEGRATION_00003 (Rte ETH parsing)
"""
import os
import pytest
...
XDM_PATH = "simple_demo_eth_rte/config/Rte.xdm"


@pytest.mark.integration
def test_rte_simple_eth_xdm_parsing():
    """Test Rte.xdm parsing from simple_demo_eth_rte."""
