"""Integration test for Rte.xdm parsing from simple_demo_can_rte.

Implements: SWR_INTEGRATION_00003 (Rte CAN parsing)
"""
import os
import pytest
...
XDM_PATH = "simple_demo_can_rte/config/Rte.xdm"


@pytest.mark.integration
def test_rte_simple_can_xdm_parsing():
    """Test Rte.xdm parsing from simple_demo_can_rte."""
