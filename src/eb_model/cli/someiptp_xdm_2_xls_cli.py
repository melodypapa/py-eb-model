...
def main():
    ...
    log_file = os.path.join(base_path, 'someiptp_xdm_2_xls.log')
    ...
    try:
        ...
        parser = SomeIpTpXdmParser()
        parser.parse_xdm(args.INPUT, doc)

        writer = SomeIpTpXdmXlsWriter()
