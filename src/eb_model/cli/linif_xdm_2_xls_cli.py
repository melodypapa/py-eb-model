...
from eb_model.parser import LinIfXdmParser
from eb_model.models import EBModel
from eb_model.reporter import LinIfXdmXlsWriter
...
def main():
    ...
    ap.add_argument("INPUT", help="The path of LinIf.xdm.")
    ...
    log_file = os.path.join(base_path, 'linif_xdm_2_xls.log')
