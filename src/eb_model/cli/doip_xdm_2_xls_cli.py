...
from ..parser import DoIPXdmParser
from ..models import EBModel
from ..reporter import DoIPXdmXlsWriter
...
def main():
    ...
    log_file = os.path.join(base_path, 'doip_xdm_2_xls.log')
    ...
    try:
        ...
        parser = DoIPXdmParser()
        parser.parse_xdm(args.INPUT, doc)

        writer = DoIPXdmXlsWriter()
