...
from eb_model.parser import ComXdmParser
from eb_model.models import EBModel
from eb_model.reporter import ComXdmXlsWriter
...
def main():
    ...
    ap.add_argument("INPUT", help="The path of Com.xdm.")
    ...
    log_file = os.path.join(base_path, 'com_xdm_2_xls.log')
