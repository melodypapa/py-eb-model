"""
CLI entry point for converting MemAcc XDM files to Excel.
"""
import sys
import argparse
import os.path
...
def main():
    """Convert MemAcc XDM file to Excel format."""
    ...
    ap.add_argument("INPUT", help="The path of MemAcc.xdm.")
    ...
    log_file = os.path.join(base_path, 'memacc_xdm_2_xls.log')
