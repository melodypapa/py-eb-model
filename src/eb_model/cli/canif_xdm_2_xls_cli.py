...
from ..parser import CanIfXdmParser
from ..models import EBModel
from ..reporter import CanIfXdmXlsWriter
...
def main():
    ...
    ap.add_argument("INPUT", help="The path of CanIf.xdm.")
    ...
    log_file = os.path.join(base_path, 'canif_xdm_2_xls.log')
