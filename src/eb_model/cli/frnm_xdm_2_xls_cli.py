...
def main():
    ...
    log_file = os.path.join(base_path, 'frnm_xdm_2_xls.log')
    ...
    try:
        ...
        parser = FrNmXdmParser()
        parser.parse_xdm(args.INPUT, doc)

        writer = FrNmXdmXlsWriter()
