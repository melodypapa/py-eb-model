...
from eb_model.parser import IpduMXdmParser
from eb_model.models import EBModel
from eb_model.reporter import IpduMXdmXlsWriter
...
def main():
    ...
    ap.add_argument("INPUT", help="The path of IpduM.xdm.")
    ...
    log_file = os.path.join(base_path, 'ipdum_xdm_2_xls.log')
